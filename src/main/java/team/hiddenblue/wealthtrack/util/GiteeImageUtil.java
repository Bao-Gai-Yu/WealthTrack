...
public class GiteeImageUtil {
    ...
    public static final String ACCESS_TOKEN = "09527e1d2bf05a5a3eaec30b13f6e96a";
    //个人空间名，需要补充
    public static final String OWNER = "cjhfighting";
    //仓库名，需要补充
    public static final String REPO_NAME = "javaeeimage";
    //文件夹路径
     ...
     * %s => 文件的路径(path)
     */
    public static String CREATE_REPOS_URL = "https://gitee.com/api/v5/repos/"+OWNER + "/" + REPO_NAME + "/contents" + PATH;
    /**
     * 获取路径下所有的内容
     * <p>
     * owner*   仓库所属空间地址(企业、组织或个人的地址path)
